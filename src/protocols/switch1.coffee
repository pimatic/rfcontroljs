module.exports = (helper) ->
  ...
  return protocolInfo = {
    ...
    pulseCount: 132
    decodePulses: (pulses) ->
      # pulses is something like: '020001000101000001000100010100010001000100000101000001000101000001000100010100000100010100010000010100000100010100000100010001000103'
