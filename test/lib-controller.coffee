...
describe '#decodePulses()', ->
  tests = [
    ...
    # },
    {
      ...
      pulses: [
        '01010110010101011010100110011001010101011010100102',
        '01010110010101011010100110011001010101011010011002',
        '01010110010101011010100110011001010101011010010102'
      ],
      values: [
        { id: 25, unit: 1, all: false, state: false }
        { id: 25, unit: 2, all: false, state: true }
        { id: 25, unit: 2, all: false, state: false }
        # { id: 25, unit: 2, all: true, state: false }
      ]
    },
    # {
    #   protocol: 'contact1'
