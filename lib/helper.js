...
module.exports = {
  ...
  binaryToNumber: function(data, b, e, direction) {
    ...
    if (direction === 'MSB-LSB') {
      return this._binaryToNumberMSBLSB(data, b, e);
    } else {
      return this._binaryToNumberLSBMSB(data, b, e);
    }
  },
  binaryToNumberSigned: function(data, b, e, direction, signedPos) {
    if (direction == null) {
      direction = 'MSB-LSB';
    }
    if (signedPos == null) {
    ...
    if (direction === 'MSB-LSB') {
      ...
      if ((parseInt(data[signedPos], 10)) === 1) {
        return this._binaryToNumberMSBLSBsigned(data, b, e);
      } else {
        return this._binaryToNumberMSBLSB(data, b, e);
      }
    } else {
      ...
      if ((parseInt(data[signedPos], 10)) === 1) {
        return this._binaryToNumberLSBMSBsigned(data, b, e);
      } else {
        return this._binaryToNumberLSBMSB(data, b, e);
      }
    }
  },
  _binaryToNumberMSBLSB: function(data, b, e) {
    var i, number;
    number = 0;
    i = b;
    while (i <= e) {
  ...
  _binaryToNumberMSBLSBsigned: function(data, b, e) {
    var i, number;
    number = ~0;
    i = b;
    while (i <= e) {
  ...
  _binaryToNumberLSBMSB: function(data, b, e) {
    var i, number;
    number = 0;
    i = e;
    while (i >= b) {
  ...
  _binaryToNumberLSBMSBsigned: function(data, b, e) {
    var i, number;
    number = ~0;
    i = e;
    while (i >= b) {
