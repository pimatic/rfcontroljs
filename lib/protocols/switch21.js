...
module.exports = function(helper) {
  ...
  return protocolInfo = {
    ...
    decodePulses: function(pulses) {
      var binary, nstate, remoteCode, result, state, unitCode, _remoteCode, _state, _unitCode;
    ...
    encodeMessage: function(message) {
      var command, id1, id2, id3, id4, id5, id6, level, unitCode, _id1, _id2, _id3, _id4, _id5, _id6, _unitCode;
