var doesProtocolMatch, file, files, fs, helper, protocols, sortIndices, this_path, _i, _len,
...
protocols = [
  ...
  'switch18', 'switch19', 'switch20', 'switch21', 'switch22'
  'rolling1'
  'dimmer1', 'dimmer2'
...
sortIndices = function(array) {
  var e, i, indices, j, tuple, tuples, _j, _k, _len1, _len2;
  ...
  for (j = _k = 0, _len2 = tuples.length; _k < _len2; j = ++_k) {
    tuple = tuples[j];
    indices[tuple[1]] = j;
  }
  return indices;
...
module.exports = {
  ...
  compressTimings: function(timings) {
    var bucket, buckets, counts, hasMatch, i, j, pulses, sums, timing, _j, _k, _l, _len1, _len2, _len3;
    pulses = '';
    buckets = [];
    sums = [];
    counts = [];
    for (i = _j = 0, _len1 = timings.length; _j < _len1; i = ++_j) {
      timing = timings[i];
      hasMatch = false;
  ...
  decodePulses: function(pulseLengths, pulses) {
    var err, fixed, p, results, values, _j, _len1;
    results = [];
